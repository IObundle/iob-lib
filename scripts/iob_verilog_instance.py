...
class iob_verilog_instance:
    def __init__(self, name="instance_0", description="default description", module=None, parameters={}):
        ...
        self.parameters = parameters # Dictionary of Verilog parameters to pass to this instance
