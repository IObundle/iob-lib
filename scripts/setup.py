...
def setup( python_module, no_overlap=False):
    ...
    if os.path.isdir(python_module.build_dir+'/software'): 
        if regs:
            mkregs_obj.write_swheader(reg_table, python_module.build_dir+'/software/src', top)
            mkregs_obj.write_swcode(reg_table, python_module.build_dir+'/software/src', top)
            mkregs_obj.write_swheader(reg_table, python_module.build_dir+'/software/src', top)
