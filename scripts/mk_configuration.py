...
def config_delivery_mk(defines, meta_data, build_delivery, delivery_dir):
    file2create = open(f"{build_delivery}/config_delivery.mk", "w")
    file2create.write("#This file was generated by script mk_configuration.py\n\n")
    file2create.write(f"NAME={meta_data['name']}\n")
    file2create.write(f"CORE_NAME={meta_data['core_name']}\n")
    file2create.write(f"VERSION={meta_data['version']}\n")
    file2create.write(f"BUILD_DIR_NAME={delivery_dir.split('/')[-1]}\n")
    file2create.write(f"FLOWS={meta_data['delivery_flows']}\n\n")
    file2create.write(f"DEFINES=\n")
