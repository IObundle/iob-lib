...
if { $IS_FPGA == "1" } {
    synth_design -include_dirs ../src -verilog_define $DEFINES -part $PART -top $NAME -verbose
} else {
    synth_design -include_dirs ../src -verilog_define $DEFINES -part $PART -top $NAME -mode out_of_context -flatten_hierarchy none -verbose
}
